...
public class Enemy extends Entity {
     ...
     */
    public Enemy(final boolean visible, final boolean tangible, final Dimension hitBox, final Dimension size, final double x, final double y) throws NullPointerException, IllegalArgumentException {
        super(visible, tangible, hitBox, size, x, y);
    }

    /**
     * Constructor instantiates a new {@link Enemy} and copies the attributes
     * of the passed Enemy to the generated instance.
     *
     * @param gameObject            Enemy whose attributes shall be copied
     *                              to this instance.
     * @throws NullPointerException The passed instance is {@code null}.
     */
    public Enemy(final Enemy gameObject) throws NullPointerException {
        super(gameObject);
    }
